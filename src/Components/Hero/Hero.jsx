        ...
        <>
            <div className="h-[70vh] w-full flex justify-center items-center">
                <section className="bg-blue-50 h-[60vh] w-[80vw] rounded-2xl flex flex-col justify-evenly items-center md:flex-row sm:p-10">
                    <img src="src\assets\Images\flug-plane.png" alt="Plane on a world tour" className="cursor-pointer md:w-[30vw] hover:-rotate-10 duration-300 hover:scale-[1.1] sm:w-[50vw]" />
