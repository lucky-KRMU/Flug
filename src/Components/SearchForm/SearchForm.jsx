...
function SearchForm({searchBy, placeholder,handleFormSubmit, value}) {
  return (
    <>
    <div className='h-[70vh] w-full flex items-center justify-center gap-2'>
            <form id='search-flight-num' onSubmit={handleFormSubmit}>
              ...
              <div className='h-20 w-100 flex items-center justify-center gap-2'>
                <input type="text" name="flight-num" id="flight-num" value={value} placeholder={`Enter the ${placeholder} Here`} className='p-4 bg-blue-50 w-full font-[Radio_Canada] font-semibold text-xl rounded-xl text-blue-950 focus:outline-0' />
